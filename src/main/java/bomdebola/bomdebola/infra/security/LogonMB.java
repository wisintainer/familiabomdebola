package bomdebola.bomdebola.infra.security;
...
import static bomdebola.bomdebola.util.Utils.addDetailMessage;
...
public class LogonMB extends AdminSession implements Serializable {
    ...
    public void login() throws IOException {
    	if(email.equals("bomdebola") && password.equals("familiabomdebola")) {
            currentUser = email;
