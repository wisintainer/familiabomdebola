...
public enum PremiacoesEnum {
	...
	PRIMEIRO_COLOCADO(1500, "Primeiro Colocado Geral"),
	SEGUNDO_COLOCADO(840,"Segundo Colocado Geral"),
	TERCEIRO_COLOCADO(500,"Terceiro Colocado Geral"),
	QUARTO_COLOCADO(400,"Quarto Colocado Geral"),
	QUINTO_COLOCADO(350,"Quinto Colocado Geral"),
	SEXTO_COLOCADO(320,"Sexto Colocado Geral"),
	SETIMO_COLOCADO(270,"Sétimo Colocado Geral"),
	OITAVO_COLOCADO(220,"Oitavo Colocado Geral"),
	NONO_COLOCADO(0,"Nono Colocado Geral"),
	DECIMO_COLOCADO(0,"Décimo Colocado Geral"),
	CAMPEAO_PRIMEIRO_TURNO(110,"Campeão do Primeiro Turno"),
	CAMPEAO_SEGUNDO_TURNO(110,"Campeão do Segundo Turno"),
	MAIOR_MITADA(110,"Maior Mitada"),
	MAIOR_MITADA_SEGUNDO_TURNO(110,"Maior Mitada Segundo Turno"),
	MAIS_RICO(220,"Mais Rico"),
